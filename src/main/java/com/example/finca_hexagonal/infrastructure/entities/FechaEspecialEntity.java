...
public class FechaEspecialEntity {
    ...
    public FechaEspecialEntity(Long id, LocalDateTime fecha, LocalDateTime dia_semana, LocalDateTime hora_inicio, LocalDateTime hora_fin, BigDecimal descuento, BigDecimal recargo, String motivo, FincaEntity finca) {
        this.id = id;
        this.fecha = fecha;

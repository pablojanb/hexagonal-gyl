...
public class comprobanteDePagoDTOResponse {
    ...
    public comprobanteDePagoDTOResponse(){};

    public comprobanteDePagoDTOResponse(Long id, Long pago_id, BigDecimal monto, Long modo_de_pago_id, String descripcion) {
        this.id = id;
